...
def get_custom_fields() -> dict:
	...
	return {
		...
		"Vehicle": [
			...
			# Created with the truck, named after the plate. An Asset cannot be
			# raised without a fixed-asset Item, so this removes that step.
			{
				"fieldname": "custom_asset_item",
				"label": "Asset Item",
				"fieldtype": "Link",
				"options": "Item",
				"read_only": 1,
				"description": "Fixed-asset Item for this vehicle, used when raising the Asset.",
		...
		"Delivery Trip": [
			...
			{
				"fieldname": "custom_customer_warehouse",
				"label": "Customer Warehouse",
				"fieldtype": "Link",
				"options": "Warehouse",
				"depends_on": "eval:doc.custom_destination_type=='Customer'",
				"description": "Site warehouse the cement is delivered into, when the customer has one.",
				"insert_after": "custom_supplier_warehouse",
			},
			{
				...
				"insert_after": "custom_customer_warehouse",
			},
			{
